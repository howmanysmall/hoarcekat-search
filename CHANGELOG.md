...
## [1.2.3]
### Added
- Added a way to toggle pattern searching in the search bar.
- Added my missing `stylua.toml` file.

### Changed
- Moved stories to a story folder.

### Fixed
- Fixed an error on plugin update.

## [1.2.2]
### Added
- Added a hook library.
- Added a search bar to filter stories.

### Changed
- Use hooks for most things.
